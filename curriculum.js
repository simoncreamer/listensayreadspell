/**
 * curriculum.js — split into sub-sets
 *
 * Sets 1–3:  both halves share all 6 sounds on the Listen screen
 * Sets 4–7:  each half has only its own sounds on the Listen screen
 * Set  8:    left as single set (silent-letter teaching pages to be added)
 * Sets 9–10: split as per brief
 */

const CURRICULUM = [

  /* ═══════════════════════════════════════════════════════════
     SET 1.1 — s, a, t, p, i, n  (groups: at · in · an)
  ═══════════════════════════════════════════════════════════ */
  {
    id: "set1-1",
    homeLabel: "Set 1.1",
    ...
    steps: [
      { type: "listen", label: "satpin", sounds: [
      ...
      { type: "spell", label: "1", group: "at", words: [
        ...
        { word: "sat", image: "images/sit.png", audio: "audio/sat spelling.mp3", emoji: "🪑" },
        { word: "pat", image: "images/pat.png", audio: "audio/pat spelling.mp3", emoji: "🐾" },
      ]},
      { type: "match", label: "1", group: "at", items: [
        { word: "at",  image: "images/at.jpg",  emoji: "🎯" },
        { word: "sat", image: "images/sit.png", emoji: "🪑" },
        { word: "pat", image: "images/pat.png", emoji: "🐾" },
      ]},
      ...
      { type: "spell", label: "2", group: "in", words: [
        { word: "in",  image: "images/in.png",  audio: "audio/in spelling.mp3",  emoji: "📥" },
        { word: "tin", image: "images/tin.png", audio: "audio/tin spelling.mp3", emoji: "🥫" },
        { word: "pin", image: "images/pin.png", audio: "audio/pin spelling.mp3", emoji: "📌" },
      ]},
      { type: "match", label: "2", group: "in", items: [
        { word: "in",  image: "images/in.png",  emoji: "📥" },
        { word: "tin", image: "images/tin.png", emoji: "🥫" },
        { word: "pin", image: "images/pin.png", emoji: "📌" },
      ]},
      ...
      { type: "spell", label: "3", group: "an", words: [
        { word: "nap", image: "images/nap.png", audio: "audio/nap spelling.mp3",    emoji: "😴" },
        { word: "tap", image: "images/tap.png", audio: "audio/tap spelling.mp3",    emoji: "🚰" },
        { word: "pan", image: "images/pan.png", audio: "audio/pan spelling.mp3",    emoji: "🍳" },
        { word: "tan", image: "images/tan.png", audio: "audio/tan v2 spelling.mp3", emoji: "🏖️" },
      ]},
      { type: "match", label: "3", group: "an", items: [
        { word: "nap", image: "images/nap.png", emoji: "😴" },
        { word: "tap", image: "images/tap.png", emoji: "🚰" },
        { word: "pan", image: "images/pan.png", emoji: "🍳" },
        { word: "tan", image: "images/tan.png", emoji: "🏖️" },
      ]},
    ],
  },

  /* ═══════════════════════════════════════════════════════════
     SET 1.2 — s, a, t, p, i, n  (groups: it · ip · ant)
  ═══════════════════════════════════════════════════════════ */
  {
    id: "set1-2",
    homeLabel: "Set 1.2",
    ...
    steps: [
      ...
      { type: "spell", label: "4", group: "it", words: [
        { word: "sit",  image: "images/sit.png",  audio: "audio/sit.mp3",  emoji: "🪑" },
      ...
      { type: "match", label: "4", group: "it", items: [
        { word: "sit",  image: "images/sit.png",  emoji: "🪑" },
      ...
      { type: "spell", label: "5", group: "ip", words: [
        { word: "tip", image: "images/tip.png", audio: "audio/tip.mp3", emoji: "💡" },
        { word: "pip", image: "images/pip.png", audio: "audio/pip.mp3", emoji: "🍎" },
        { word: "nip", image: "images/nip.png", audio: "audio/nip.mp3", emoji: "🤏" },
        { word: "sip", image: "images/sip.jpg", audio: "audio/sip.mp3", emoji: "🥤" },
      ]},
      { type: "match", label: "5", group: "ip", items: [
        { word: "tip", image: "images/tip.png", emoji: "💡" },
        { word: "pip", image: "images/pip.png", emoji: "🍎" },
        { word: "nip", image: "images/nip.png", emoji: "🤏" },
      ...
      { type: "spell", label: "6", group: "ant", words: [
        { word: "ant",   image: "images/ant.png",   audio: "audio/ant.mp3",   emoji: "🐜" },
      ...
      { type: "match", label: "6", group: "ant", items: [
        { word: "ant",   image: "images/ant.png",   emoji: "🐜" },
  ...
  /* ═══════════════════════════════════════════════════════════
     SET 2.1 — ck, e, h, r, m, d  (groups: hat · pen · tent)
  ═══════════════════════════════════════════════════════════ */
  {
    id: "set2-1",
    homeLabel: "Set 2.1",
    ...
    steps: [
      ...
      { type: "spell", label: "1", group: "hat", words: [
        { word: "hat", image: "images/hat.png", audio: "audio/hat.mp3", emoji: "🎩" },
        { word: "mat", image: "images/mat.jpg", audio: "audio/mat.mp3", emoji: "🟫" },
        { word: "cat", image: "images/cat.png", audio: "audio/cat.mp3", emoji: "🐱" },
      ]},
      { type: "match", label: "1", group: "hat", items: [
        { word: "hat", image: "images/hat.png", emoji: "🎩" },
        { word: "mat", image: "images/mat.jpg", emoji: "🟫" },
        { word: "cat", image: "images/cat.png", emoji: "🐱" },
      ]},
      ...
      { type: "spell", label: "2", group: "pen", words: [
        { word: "pen", image: "images/pen.png", audio: "audio/pen.mp3", emoji: "🖊️" },
        { word: "hen", image: "images/hen.png", audio: "audio/hen.mp3", emoji: "🐔" },
        { word: "ten", image: "images/ten.jpg", audio: "audio/ten.mp3", emoji: "🔟" },
        { word: "red", image: "images/red.png", audio: "audio/red.mp3", emoji: "🔴" },
      ]},
      { type: "match", label: "2", group: "pen", items: [
        { word: "pen", image: "images/pen.png", emoji: "🖊️" },
        { word: "hen", image: "images/hen.png", emoji: "🐔" },
        { word: "ten", image: "images/ten.jpg", emoji: "🔟" },
        { word: "red", image: "images/red.png", emoji: "🔴" },
      ]},
  ...
  /* ═══════════════════════════════════════════════════════════
     SET 2.2 — ck, e, h, r, m, d  (groups: hip · sad · sick)
  ═══════════════════════════════════════════════════════════ */
  {
    id: "set2-2",
    homeLabel: "Set 2.2",
    ...
    steps: [
      ...
      { type: "spell", label: "4", group: "hip", words: [
        { word: "hip", image: "images/hip.png", audio: "audio/hip.mp3", emoji: "🦴" },
        { word: "rip", image: "images/rip.png", audio: "audio/rip.mp3", emoji: "😬" },
        { word: "net", image: "images/net.jpg", audio: "audio/net.mp3", emoji: "🥅" },
      ]},
      { type: "match", label: "4", group: "hip", items: [
        { word: "hip", image: "images/hip.png", emoji: "🦴" },
        { word: "rip", image: "images/rip.png", emoji: "😬" },
        { word: "net", image: "images/net.jpg", emoji: "🥅" },
      ]},
      ...
      { type: "spell", label: "5", group: "sad", words: [
        { word: "sad", image: "images/sad.jpg", audio: "audio/sad.mp3", emoji: "😢" },
        { word: "man", image: "images/man.png", audio: "audio/man.mp3", emoji: "👨" },
        { word: "mad", image: "images/mad.jpg", audio: "audio/mad.mp3", emoji: "😡" },
      ]},
      { type: "match", label: "5", group: "sad", items: [
        { word: "sad", image: "images/sad.jpg", emoji: "😢" },
        { word: "man", image: "images/man.png", emoji: "👨" },
        { word: "mad", image: "images/mad.jpg", emoji: "😡" },
      ]},
  ...
  /* ═══════════════════════════════════════════════════════════
     SET 3.1 — g, o, u, l, f, b  (groups: fit · bun · bug)
  ═══════════════════════════════════════════════════════════ */
  {
    id: "set3-1",
    homeLabel: "Set 3.1",
    ...
    steps: [
      ...
      { type: "spell", label: "1", group: "fit", words: [
        { word: "fit", image: "images/fit.jpg", audio: "audio/fit.mp3", emoji: "💪" },
        { word: "gap", image: "images/gap.png", audio: "audio/gap.mp3", emoji: "↔️" },
        { word: "bit", image: "images/bit.jpg", audio: "audio/bit.mp3", emoji: "🔩" },
      ]},
      { type: "match", label: "1", group: "fit", items: [
        { word: "fit", image: "images/fit.jpg", emoji: "💪" },
        { word: "gap", image: "images/gap.png", emoji: "↔️" },
        { word: "bit", image: "images/bit.jpg", emoji: "🔩" },
      ]},
      ...
      { type: "spell", label: "2", group: "bun", words: [
        { word: "bun", image: "images/bun.jpg", audio: "audio/bun.mp3", emoji: "🍞" },
        { word: "gum", image: "images/gum.png", audio: "audio/gum.mp3", emoji: "🫧" },
        { word: "fog", image: "images/fog.jpg", audio: "audio/fog.mp3", emoji: "🌫️" },
        { word: "bum", image: "images/bum.jpg", audio: "audio/bum.mp3", emoji: "🍑" },
      ]},
      { type: "match", label: "2", group: "bun", items: [
        { word: "bun", image: "images/bun.jpg", emoji: "🍞" },
        { word: "gum", image: "images/gum.png", emoji: "🫧" },
        { word: "fog", image: "images/fog.jpg", emoji: "🌫️" },
        { word: "bum", image: "images/bum.jpg", emoji: "🍑" },
      ]},
      ...
      { type: "spell", label: "3", group: "bug", words: [
        { word: "bug",  image: "images/bug.jpg",  audio: "audio/bug.mp3",  emoji: "🐛" },
        { word: "frog", image: "images/frog.jpg", audio: "audio/frog.mp3", emoji: "🐸" },
        { word: "flag", image: "images/flag.jpg", audio: "audio/flag.mp3", emoji: "🚩" },
      ]},
      { type: "match", label: "3", group: "bug", items: [
        { word: "bug",  image: "images/bug.jpg",  emoji: "🐛" },
        { word: "frog", image: "images/frog.jpg", emoji: "🐸" },
        { word: "flag", image: "images/flag.jpg", emoji: "🚩" },
      ]},
    ],
  },

  /* ═══════════════════════════════════════════════════════════
     SET 3.2 — g, o, u, l, f, b  (groups: dog · leg · gold)
  ═══════════════════════════════════════════════════════════ */
  {
    id: "set3-2",
    homeLabel: "Set 3.2",
    ...
    steps: [
      ...
      { type: "spell", label: "4", group: "dog", words: [
        { word: "dog", image: "images/dog.png", audio: "audio/dog.mp3", emoji: "🐶" },
        { word: "fun", image: "images/fun.jpg", audio: "audio/fun.mp3", emoji: "🎉" },
        { word: "gut", image: "images/gut.jpg", audio: "audio/gut.mp3", emoji: "🫃" },
      ]},
      { type: "match", label: "4", group: "dog", items: [
        { word: "dog", image: "images/dog.png", emoji: "🐶" },
        { word: "fun", image: "images/fun.jpg", emoji: "🎉" },
        { word: "gut", image: "images/gut.jpg", emoji: "🫃" },
      ]},
      ...
      { type: "spell", label: "5", group: "leg", words: [
        { word: "leg", image: "images/leg.png", audio: "audio/leg.mp3", emoji: "🦵" },
        { word: "bag", image: "images/bag.png", audio: "audio/bag.mp3", emoji: "👜" },
        { word: "cup", image: "images/cup.png", audio: "audio/cup.mp3", emoji: "☕" },
        { word: "log", image: "images/log.png", audio: "audio/log.mp3", emoji: "🪵" },
      ]},
      { type: "match", label: "5", group: "leg", items: [
        { word: "leg", image: "images/leg.png", emoji: "🦵" },
        { word: "bag", image: "images/bag.png", emoji: "👜" },
        { word: "cup", image: "images/cup.png", emoji: "☕" },
        { word: "log", image: "images/log.png", emoji: "🪵" },
      ]},
      ...
      { type: "spell", label: "6", group: "gold", words: [
        { word: "gold", image: "images/gold.png", audio: "audio/gold.mp3", emoji: "🥇" },
        { word: "fold", image: "images/fold.png", audio: "audio/fold.mp3", emoji: "📄" },
        { word: "golf", image: "images/golf.png", audio: "audio/golf.mp3", emoji: "⛳" },
      ]},
      { type: "match", label: "6", group: "gold", items: [
        { word: "gold", image: "images/gold.png", emoji: "🥇" },
        { word: "fold", image: "images/fold.png", emoji: "📄" },
        { word: "golf", image: "images/golf.png", emoji: "⛳" },
      ]},
    ],
  },
  ...
  ═══════════════════════════════════════════════════════════ */
  {
    ...
    steps: [
      ...
      { type: "spell", label: "1", group: "jam", words: [
        { word: "jam",  image: "images/jam.png",  audio: "audio/jam.mp3",  emoji: "🍓" },
        { word: "jet",  image: "images/jet.png",  audio: "audio/jet.mp3",  emoji: "✈️" },
        { word: "jog",  image: "images/jog.png",  audio: "audio/jog.mp3",  emoji: "🏃" },
        { word: "jump", image: "images/jump.png", audio: "audio/jump.mp3", emoji: "🦘" },
      ]},
      { type: "match", label: "1", group: "jam", items: [
        { word: "jam",  image: "images/jam.png",  emoji: "🍓" },
        { word: "jet",  image: "images/jet.png",  emoji: "✈️" },
        { word: "jog",  image: "images/jog.png",  emoji: "🏃" },
        { word: "jump", image: "images/jump.png", emoji: "🦘" },
      ]},
  ...
  ═══════════════════════════════════════════════════════════ */
  {
    id: "set4-2",
    homeLabel: "Set 4.2",
    homeSounds: "<u>ai</u> · <u>oa</u> · <u>or</u>",
    steps: [
      { type: "listen", label: "sounds", sounds: [
  ...
  ═══════════════════════════════════════════════════════════ */
  {
    ...
    steps: [
      ...
      { type: "spell", label: "1", group: "zip", words: [
        { word: "zip",    image: "images/zip.jpg",    audio: "audio/zip.mp3",    emoji: "🤐" },
        { word: "zigzag", image: "images/zigzag.jpg", audio: "audio/zigzag.mp3", emoji: "〰️" },
        { word: "zinc",   image: "images/zinc.png",   audio: "audio/zinc.mp3",   emoji: "⚗️" },
      ]},
      { type: "match", label: "1", group: "zip", items: [
        { word: "zip",    image: "images/zip.jpg",    emoji: "🤐" },
        { word: "zigzag", image: "images/zigzag.jpg", emoji: "〰️" },
        { word: "zinc",   image: "images/zinc.png",   emoji: "⚗️" },
      ]},
      ...
      { type: "spell", label: "2", group: "wet", words: [
        { word: "wet",  image: "images/wet.jpg",  audio: "audio/wet.mp3",  emoji: "💧" },
        { word: "wind", image: "images/wind.jpg", audio: "audio/wind.mp3", emoji: "💨" },
        { word: "west", image: "images/west.jpg", audio: "audio/west.mp3", emoji: "🧭" },
      ]},
      { type: "match", label: "2", group: "wet", items: [
        { word: "wet",  image: "images/wet.jpg",  emoji: "💧" },
        { word: "wind", image: "images/wind.jpg", emoji: "💨" },
        { word: "west", image: "images/west.jpg", emoji: "🧭" },
      ]},
  ...
  /* ═══════════════════════════════════════════════════════════
     SET 5.2 — v, oo (book), oo (moon)
  ═══════════════════════════════════════════════════════════ */
  {
    id: "set5-2",
    homeLabel: "Set 5.2",
    homeSounds: "v · <u>oo</u> (book) · <u>oo</u> (moon)",
    steps: [
      { type: "listen", label: "sounds", sounds: [
        { letter: "v",       display: "v",         audio: "audio/v.mp3" },
        { letter: "oo-book", display: "<u>oo</u>", audio: "audio/oo_book.mp3" },
        { letter: "oo-moon", display: "<u>oo</u>", audio: "audio/oo.mp3" },
      ]},
      ...
      { type: "spell", label: "4", group: "van", words: [
        { word: "van",  image: "images/van.jpg",  audio: "audio/van.mp3",  emoji: "🚐" },
        { word: "vet",  image: "images/vet.jpg",  audio: "audio/vet.mp3",  emoji: "🐾" },
        { word: "vest", image: "images/vest.jpg", audio: "audio/vest.mp3", emoji: "🦺" },
      ]},
      { type: "match", label: "4", group: "van", items: [
        { word: "van",  image: "images/van.jpg",  emoji: "🚐" },
        { word: "vet",  image: "images/vet.jpg",  emoji: "🐾" },
        { word: "vest", image: "images/vest.jpg", emoji: "🦺" },
      ]},
  ...
  ═══════════════════════════════════════════════════════════ */
  {
    ...
    steps: [
      ...
      { type: "spell", label: "1", group: "yes", words: [
        { word: "yes", image: "images/yes.jpg", audio: "audio/yes.mp3", emoji: "✅" },
        { word: "yam", image: "images/yam.jpg", audio: "audio/yam.mp3", emoji: "🍠" },
        { word: "yum", image: "images/yum.jpg", audio: "audio/yum.mp3", emoji: "😋" },
      ]},
      { type: "match", label: "1", group: "yes", items: [
        { word: "yes", image: "images/yes.jpg", emoji: "✅" },
        { word: "yam", image: "images/yam.jpg", emoji: "🍠" },
        { word: "yum", image: "images/yum.jpg", emoji: "😋" },
      ]},
      ...
      { type: "spell", label: "2", group: "box", words: [
        { word: "box",  image: "images/box.jpg",  audio: "audio/box.mp3",  emoji: "📦" },
        { word: "six",  image: "images/six.jpg",  audio: "audio/six.mp3",  emoji: "6️⃣" },
        { word: "text", image: "images/text.jpg", audio: "audio/text.mp3", emoji: "💬" },
      ]},
      { type: "match", label: "2", group: "box", items: [
        { word: "box",  image: "images/box.jpg",  emoji: "📦" },
        { word: "six",  image: "images/six.jpg",  emoji: "6️⃣" },
        { word: "text", image: "images/text.jpg", emoji: "💬" },
      ]},
  ...
  /* ═══════════════════════════════════════════════════════════
     SET 6.2 — sh, th (thin), th (that)
  ═══════════════════════════════════════════════════════════ */
  {
    id: "set6-2",
    homeLabel: "Set 6.2",
    homeSounds: "<u>sh</u> · <u>th</u> (thin) · <u>th</u> (that)",
    steps: [
      { type: "listen", label: "sounds", sounds: [
        { letter: "sh",      display: "<u>sh</u>", audio: "audio/sh.mp3" },
        { letter: "th-thin", display: "<u>th</u>", audio: "audio/th_thin.mp3" },
        { letter: "th-that", display: "<u>th</u>", audio: "audio/th.mp3" },
      ]},
  ...
  ═══════════════════════════════════════════════════════════ */
  {
    id: "set7-1",
    homeLabel: "Set 7.1",
    homeSounds: "<u>qu</u> · <u>ou</u> · <u>oi</u>",
    steps: [
      { type: "listen", label: "sounds", sounds: [
  ...
  ═══════════════════════════════════════════════════════════ */
  {
    id: "set7-2",
    homeLabel: "Set 7.2",
    homeSounds: "<u>ue</u> · <u>er</u> · <u>ar</u>",
    steps: [
      { type: "listen", label: "sounds", sounds: [
...
/* ═══════════════════════════════════════════════════════════════
   SET 8 — FULL REPLACEMENT
   Replace the entire existing set8 object in curriculum.js with
   the three objects below (set8-1, set8-2, set8-3).
   ═══════════════════════════════════════════════════════════════ */

  /* ═══════════════════════════════════════════════════════════
     SET 8.1 — a_e (ai sound), i_e (ie sound)
  ═══════════════════════════════════════════════════════════ */
  {
    id: "set8-1",
    homeLabel: "Set 8.1",
  ...
  /* ═══════════════════════════════════════════════════════════
     SET 8.2 — o_e (oa sound), u_e (ue sound)
  ═══════════════════════════════════════════════════════════ */
  {
    id: "set8-2",
    homeLabel: "Set 8.2",
  ...
  /* ═══════════════════════════════════════════════════════════
     SET 8.3 — e (ee), y (ee), i (ie)
     Standard format — same as Sets 1–7
  ═══════════════════════════════════════════════════════════ */
  {
    id: "set8-3",
    homeLabel: "Set 8.3",
    ...
    steps: [
      ...
      { type: "listen", label: "sounds", sounds: [
        ...
        { letter: "i", display: "i", audio: "audio/i_hi.mp3" },
      ]},

      /* Step 2 — Say: me, he, she, we */
      { type: "say", label: "1", group: "e-me", rows: [
      ...
      /* Step 3 — Spell: me, he, she, we */
      { type: "spell", label: "1", group: "e-me-spell", words: [
        { word: "me",  image: "images/me.png",  audio: "audio/me.mp3",  emoji: "🧑" },
        { word: "he",  image: "images/he.png",  audio: "audio/he.mp3",  emoji: "👨" },
        { word: "she", image: "images/she.png", audio: "audio/she.mp3", emoji: "👩" },
        { word: "we",  image: "images/we.png",  audio: "audio/we.mp3",  emoji: "👫" },
      ]},

      /* Step 4 — Match: me, he, she, we */
      { type: "match", label: "1", group: "e-me-match", items: [
        { word: "me",  image: "images/me.png",  emoji: "🧑" },
        { word: "he",  image: "images/he.png",  emoji: "👨" },
        { word: "she", image: "images/she.png", emoji: "👩" },
        { word: "we",  image: "images/we.png",  emoji: "👫" },
      ]},

      /* Step 5 — Say: sunny, funny, merry, lucky */
      { type: "say", label: "2", group: "y-funny", rows: [
        ...
        { phonemes: "l · u · ck · y",    display: "lucky", word: "lucky", audio: "audio/lucky.mp3", phonemeAudio: "audio/lucky.mp3" },
      ]},

      /* Step 6 — Spell: sunny, funny, merry, lucky */
      { type: "spell", label: "2", group: "y-funny-spell", words: [
        { word: "sunny", image: "images/sunny.png", audio: "audio/sunny.mp3", emoji: "☀️" },
        { word: "funny", image: "images/funny.png", audio: "audio/funny.mp3", emoji: "😄" },
        { word: "merry", image: "images/merry.png", audio: "audio/merry.mp3", emoji: "🎄" },
        { word: "lucky", image: "images/lucky.png", audio: "audio/lucky.mp3", emoji: "🍀" },
      ]},

      /* Step 7 — Match: sunny, funny, merry, lucky */
      { type: "match", label: "2", group: "y-funny-match", items: [
        { word: "sunny", image: "images/sunny.png", emoji: "☀️" },
        { word: "funny", image: "images/funny.png", emoji: "😄" },
        { word: "merry", image: "images/merry.png", emoji: "🎄" },
        { word: "lucky", image: "images/lucky.png", emoji: "🍀" },
      ]},

      /* Step 8 — Say: hi, pilot, final */
      { type: "say", label: "3", group: "i-hi", rows: [
      ...
      /* Step 9 — Spell: hi, pilot, final */
      { type: "spell", label: "3", group: "i-hi-spell", words: [
        { word: "hi",    image: "images/hi.png",    audio: "audio/hi.mp3",    emoji: "👋" },
        { word: "pilot", image: "images/pilot.png", audio: "audio/pilot.mp3", emoji: "👨‍✈️" },
        { word: "final", image: "images/final.png", audio: "audio/final.mp3", emoji: "🏁" },
      ]},

      /* Step 10 — Match: hi, pilot, final */
      { type: "match", label: "3", group: "i-hi-match", items: [
        { word: "hi",    image: "images/hi.png",    emoji: "👋" },
        { word: "pilot", image: "images/pilot.png", emoji: "👨‍✈️" },
        { word: "final", image: "images/final.png", emoji: "🏁" },
      ]},
    ],
  },
  ...
  /* ═══════════════════════════════════════════════════════════
     SET 10.2 — ow (grow), ow (now)
  ═══════════════════════════════════════════════════════════ */
  {
    id: "set10-2",
    homeLabel: "Set 10.2",
    homeSounds: "<u>ow</u> (grow) · <u>ow</u> (now)",
    steps: [
      { type: "listen", label: "sounds", sounds: [
        { letter: "ow-grow", display: "<u>ow</u>", audio: "audio/ow_grow.mp3" },
        { letter: "ow-now",  display: "<u>ow</u>", audio: "audio/ow.mp3" },
      ]},
