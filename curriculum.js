...
const CURRICULUM = [
  {
    ...
    steps: [
      ...
      /* ── Group 5: ip ────────────────────────────────────────── */
      {
        ...
        group: "ip",
        rows: [
          { phonemes: "t · i · p", word: "tip", audio: "audio/tip.mp3", phonemeAudio: ["audio/t.mp3","audio/i.mp3","audio/p.mp3"] },
          { phonemes: "p · i · p", word: "pip", audio: "audio/pip.mp3", phonemeAudio: ["audio/p.mp3","audio/i.mp3","audio/p.mp3"] },
          { phonemes: "n · i · p", word: "nip", audio: "audio/nip.mp3", phonemeAudio: ["audio/n.mp3","audio/i.mp3","audio/p.mp3"] },
          { phonemes: "s · i · p", word: "sip", audio: "audio/sip.mp3", phonemeAudio: ["audio/s.mp3","audio/i.mp3","audio/p.mp3"] },
        ],
      },
      {
        type: "spell",
      ...
      /* ── Group 6: ant ───────────────────────────────────────── */
      {
        ...
        group: "ant",
        rows: [
          { phonemes: "a · n · t",         word: "ant",   audio: "audio/ant.mp3",   phonemeAudio: ["audio/a.mp3","audio/n.mp3","audio/t.mp3"] },
          { phonemes: "p · a · n · t · s", word: "pants", audio: "audio/pants.mp3", phonemeAudio: ["audio/p.mp3","audio/a.mp3","audio/n.mp3","audio/t.mp3","audio/s.mp3"] },
          { phonemes: "s · n · a · p",     word: "snap",  audio: "audio/snap.mp3",  phonemeAudio: ["audio/s.mp3","audio/n.mp3","audio/a.mp3","audio/p.mp3"] },
        ],
      },
      {
        type: "spell",
